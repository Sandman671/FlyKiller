...
public class Sapo implements Runnable {
    ...
    AudioClip sonidos = java.applet.Applet.newAudioClip(getClass().getResource("/flykiller/Resources/sapo.wav"));
    ...
    public Sapo(int x, int y, JPanel panel, ArrayList moscas) {
        ...
        this.moscas = moscas;
        mosca = new ImageIcon(getClass().getResource("/flykiller/Resources/toad1.jpg")).getImage();
        animar();
    }

    private void comerMosca() {
    ...
    public void run() {
        while (true) {
            try {
                ...
                Logger.getLogger(Sapo.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
